  ...
  return (
    <div className="relative w-full md:mr-3 lg:mr-10">
      <form onSubmit={handleSearch}>
        <InputGroup className="flex bg-[#f8f5f0]">
          <InputGroup.Text>
            ...
            <div className="divide-y divide-brand/5">
              {suggestions.map((p) => (
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3 hover:bg-[#f8f5f0] transition-colors text-left"
                >
                  <div className="relative w-12 h-12 flex-shrink-0 rounded bg-[#f8f5f0] overflow-hidden">
              ...
              <button
                ...
                className="w-full p-3 text-center text-sm font-medium text-brand hover:bg-[#f8f5f0] transition-colors"
              >
