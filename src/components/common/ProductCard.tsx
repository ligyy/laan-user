  ...
  return (
    ...
    >
      <div
        className={
          isCircle
            ? "relative bg-[#f8f5f0] rounded-full w-[140px] h-[140px] sm:w-[180px] sm:h-[180px] md:w-[220px] md:h-[220px] lg:w-[260px] lg:h-[260px] xl:w-[295px] xl:h-[295px] mx-auto mb-3 overflow-hidden"
            : "relative bg-[#f8f5f0] rounded-[13px] lg:rounded-[20px] w-full lg:max-w-[295px] aspect-square mb-2.5 xl:mb-4 overflow-hidden"
        }
      >
        {/* <Image
          src={data.srcUrl}
