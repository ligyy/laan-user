            ...
            <CarouselContent className="mx-4 xl:mx-0 space-x-6">
              {categories.map(cat => (
                <CarouselItem key={cat._id} className="pl-0 basis-auto">
                  ...
                  >
                    <div className="relative w-[140px] h-[140px] sm:w-[180px] sm:h-[180px] rounded-full overflow-hidden bg-[#f8f5f0] border-2 border-transparent group-hover:border-brand transition-all duration-300 shrink-0">
                      {cat.image ? (
                        <Image
                          src={cat.image}
                          alt={cat.name}
