  ...
  return (
    <>
      <style>{`
        ...
        .btn-primary:hover { background: #8a5228; transform: translateY(-2px); }
        ...
        .btn-ghost:hover { background: #4a2c1d; color: #fff; transform: translateY(-2px); }
        ...
        .progress-bar {
          ...
          left: 0;
          height: 3px;
          background: linear-gradient(90deg, #4a2c1d, #d4a574);
        ...
        .arrow-btn svg { stroke: #4a2c1d; transition: stroke 0.2s; }
        ...
        .slide-counter span { color: #4a2c1d; font-weight: 500; }
          ...
          <div className="text-block">
            ...
            <div className="btn-row">
              ...
              {slides[current].ctaSecondary && (
                <button className="btn-ghost">{slides[current].ctaSecondary}</button>
              )}
            </div>
          </div>
        </div>
